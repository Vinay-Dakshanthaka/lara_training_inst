...
const EvaluateDescriptivePlacementTest = () => {
    ...
    // Sort tests in descending order based on wt_id (or any other field)
    const sortedTests = [...tests].sort((a, b) => b.wt_id - a.wt_id);  // Replace `wt_id` with the field you want to sort by
...
export default EvaluateDescriptivePlacementTest;