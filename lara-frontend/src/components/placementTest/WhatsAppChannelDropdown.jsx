...
const WhatsAppChannelDropdown = ({ onSelectChannel }) => {
    ...
    useEffect(() => {
        const fetchChannels = async () => {
            try {
                ...
                const response = await axios.get(`${baseURL}/api/placement-test/fetchWhatsAppChannelLinks`, config);
                ...
                <Form.Group controlId="formWhatsAppChannel">
                    ...
                    <Form.Control as="select" value={selectedChannel} onChange={handleChannelSelect}>
                        ...
                        {channels.map((channel) => (
                            <option key={channel.id} value={channel.link}>
...
export default WhatsAppChannelDropdown;
