...
//         const questions = response.data.questions;
//         setQuestionsWithAnswers(questions);
//         questions.forEach((question) => fetchCorrectAnswer(question.question_id));
//       })
...
//         setAnswerKeywords((prev) => ({
//           ...prev,
//           [question_id]: response.data.keywords,
//         }));
//       })
//       .catch(() => toast.error("Error fetching correct answer."));
//   };
...
//           prev.map((item) =>
//             item.question_id === question_id
//               ? { ...item, studentAnswer: { ...item.studentAnswer, marks, comment } }
//               : item
//           )
//         );
//       })
//       .catch(() => toast.error("Error updating marks and comments."));
//   };
...
//                   ? { ...q, studentAnswer: { ...q.studentAnswer, marks, comment } }
//                   : q
//               )
//             );
//           })
...
//     if (allUpdated) toast.success("Answers auto-evaluated successfully!");
//     else toast.error("There was an error during auto evaluation.");
//   };
...
//         evaluation: true,
//       })
//       .then(() => toast.success("Final Evaluation Completed Successfully!"))
//       .catch(() => toast.error("Error completing final evaluation."));
//   };
...
//             Automated Evaluation
//           </Button>
//           <Button variant="success" onClick={handleFinalEvaluation} className="my-3 mx-3">
//             Final Evaluation
//           </Button>
//           <ToastContainer />
...
//                     value={updatedMarks[item.question_id] || item.studentAnswer.marks}
//                     onChange={(e) =>
//                       setUpdatedMarks({ ...updatedMarks, [item.question_id]: e.target.value })
//                     }
//                   />
//                 </Form.Group>
...
//                     value={updatedComment[item.question_id] || item.studentAnswer.comment || ""}
//                     onChange={(e) =>
//                       setUpdatedComment({ ...updatedComment, [item.question_id]: e.target.value })
//                     }
//                   />
//                 </Form.Group>
