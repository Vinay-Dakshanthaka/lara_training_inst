...
//     // State for test type (MCQ or Written Text)
//     const [testType, setTestType] = useState('mcq'); // Default is 'mcq'
...
//             is_active: isActive,
//             is_monitored: isMonitored,
//             test_date: dateAndTime,
//             test_type: testType === 'written' // Pass `true` for written, `false` for MCQ
//         };
