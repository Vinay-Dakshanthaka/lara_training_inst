    ...
    <div>
      ...
      {bestPerformerData && (
        <div className='my-3'>
          ...
          <p className='display-5'>Student Name: {bestPerformerData.student.name}</p>
          {bestPerformerData.profile && (
            <table className="table">
              ...
              <tbody>
                <tr>
                  <td>{bestPerformerData.profile.highest_education}</td>
                  <td>{bestPerformerData.profile.specialization}</td>
                  <td>{bestPerformerData.collegeName}</td>
                </tr>
              </tbody>
            </table>
          )}
